...
public class Parser 
{
	...
	static ResolveStatement parseRemember(String name)
	{
		ResolveStatement rs1 = new ResolveStatement(name);
		return rs1;
	}
	...
	static void parseStatement(String s)
	{
		...
		else if(theParts[0].equals("resolve"))
		{
			...
			theListOfStatements.add(Parser.parseRemember(theParts[0],
					theParts[1]));
		}
		else
			System.out.print("Parsing is not done correctly");
	}
}
